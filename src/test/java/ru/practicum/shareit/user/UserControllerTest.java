...
class UserControllerTest {
    ...
    void createUserWheUserEmailIsNotValidShouldReturnBadRequest() {
        ...
        verify(userService, never()).create(userDtoToCreate);
    }
    ...
    void updateUserWhenUserIsValid() {
        ...
        when(userService.update(userDtoToUpdate, userId)).thenReturn(userDtoToUpdate);
    ...
    void updateUserWheUserEmailIsNotValidShouldReturnBadRequest() {
        ...
        verify(userService, never()).create(userDtoToUpdate);
    }
